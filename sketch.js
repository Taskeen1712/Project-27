...
function setup() {
	...
	rope2 = new Rope(bob1.body,roof.body,{x:80,y:20});
	rope3 = new Rope(bob1.body,roof.body,{x:120,y:20});
	rope4 = new Rope(bob1.body,roof.body,{x:160,y:20});
	rope5 = new Rope(bob1.body,roof.body,{x:200,y:20});
